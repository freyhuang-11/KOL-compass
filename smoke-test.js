...
async function main() {
  ...
  assert("outreach flow supports target collaboration with multi-product commissions", ["targetCollaborations: []", "productMultiPicker", "selectedOutreachProducts", "standardCommissionRate", "adCommissionRate", "createTargetCollaborationDraft", "targetCollaborationId", "productsSnapshot", "待API发送", "定向邀约 + 触达通知"].every((text) => app.includes(text)));
