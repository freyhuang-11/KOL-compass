...
async function main() {
  ...
  assert("outreach pending API records can be submitted in batch", ["submitPendingOutreachBatch", "提交全部待API发送", "联系方式补充中", "批量提交建联", "emailConfigBlocked"].every((text) => app.includes(text)));
