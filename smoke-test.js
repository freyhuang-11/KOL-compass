...
async function main() {
  ...
  assert("outreach records show delivery results by channel", ["outreachDeliveryCell", "deliveryPill", "delivery-stack", "delivery-pill", "发送结果", "定向邀约", "TikTok私信", "Email", "缺少官方ID"].every((text) => app.includes(text) || read("app.css").includes(text)));
