...
- 2026-06-22 18:28 CST：达人库客户侧入口已收敛为“系统默认抓取 + 客户筛选建联”。客户不再看到 `从TikTok导入达人`、`导入CSV达人`、`下载KOL模板`、`手动补充达人`、`编辑达人/联系方式`；绑定/读取授权店铺后会自动抓取达人，进入达人库或切换店铺时若当前市场没有真实达人也会后台自动抓取。达人基础信息只能由平台内部后续管理能力补充，不在客户侧暴露。
