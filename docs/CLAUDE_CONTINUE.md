...
最近一次心跳检查：2026-06-22 05:19 CST，当前分支已连接 GitHub 远端，`node --check app.js` 与 `node smoke-test.js` 通过。本轮增强 KOL 黑名单：统计、达人/类目/地区/原因搜索、拉黑原因、拉黑时间、移出日志；截图 `smoke-blacklist.png` 已生成并目视检查通过。
