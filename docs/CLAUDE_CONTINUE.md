...
最近一次心跳检查：2026-06-22 05:02 CST，当前分支已连接 GitHub 远端，`node --check app.js` 与 `node smoke-test.js` 通过。本轮增强控制台：本月/近7天/近30天/全部时间范围筛选、负责人筛选、指标下钻、内容状态分布和负责人概览；截图 `smoke-dashboard.png` 已重新生成并目视检查通过。
